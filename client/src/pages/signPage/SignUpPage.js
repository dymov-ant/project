        ...
        <div>
            <div className="sign">
                ...
                <form className="sign_form mb-1">
                    <input className="form-control mb-05" type="text" placeholder="Имя и фамилия"/>
                    <input className="form-control mb-05" type="email" placeholder="Email"/>
                    <input className="form-control mb-05" type="password" placeholder="Пароль"/>
                    <label htmlFor=""><p className="subtext">Дата рождения</p></label>
                    <input className="form-control mb-1" type="date" placeholder="Дата рождения"/>
